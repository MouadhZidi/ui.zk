...
//    	td.appendChild(lstDate.getComponent());
    ...
    private void updateRoleList()
    {
        ...
        if(!Language.getLoginLanguage().isLeftToRight()) {
    		...
    		lblRole.setStyle("float: left;");
    		lstRole.setStyle("float: right;");
    		lblClient.setStyle("float: left");
    		lstClient.setStyle("float: right");
    		lblDef.setStyle("float: left");
    		lblOrganisation.setStyle("float: left");
    		lstOrganisation.setStyle("float: right");
    		lblWarehouse.setStyle("float: left");
    		lstWarehouse.setStyle("float: right");
    		lblDate.setStyle("float: left");
    		
    	
    	}
    	else {
    		this.setStyle("direction: ltr");
    		lblRole.setStyle("float: right;");
    		lstRole.setStyle("float: left;");
    		lblClient.setStyle("float: right");
    		lstClient.setStyle("float: left");
    		lblDef.setStyle("float: right");
    		lblOrganisation.setStyle("float: right");
    		lstOrganisation.setStyle("float: left");
    		lblWarehouse.setStyle("float: right");
    		lstWarehouse.setStyle("float: left");
    		lblDate.setStyle("float: right");
