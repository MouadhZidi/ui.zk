...
public class MenuTreePanel extends AbstractMenuPanel
{
    ...
    protected void initComponents()
    {
        ...
        if(!Language.getLoginLanguage().isLeftToRight()) {
    		...
    		expandToggle.setStyle("float: left;");
    		filterPanel.setStyle("float: left;");
    		filterBtn.setStyle("float: left;");
    	}
    	else {
    		this.setStyle("direction: ltr");
    		expandToggle.setStyle("float: right;");
    		filterPanel.setStyle("float: right;");
    		filterBtn.setStyle("float: right;");
    	} 
    }
