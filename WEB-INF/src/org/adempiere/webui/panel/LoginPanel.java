...
public class LoginPanel extends Window implements EventListener<Event>
{
	...
	protected void createUI() {
        ...
        okBtn = pnlButtons.getButton(ConfirmPanel.A_OK);
        okBtn.setWidgetListener("onClick", "zAu.cmd0.showBusy(null)");

//       helpButton = pnlButtons.createButton(ConfirmPanel.A_HELP);
...
//		helpButton.setSclass(ITheme.LOGIN_BUTTON_CLASS);
		...
		//pnlButtons.addComponentsLeft(helpButton);
		pnlButtons.addComponentsLeft(okBtn);
		}
		else {
			//pnlButtons.addComponentsRight(helpButton);
			pnlButtons.addComponentsRight(okBtn);
		}
...
//        txtPassword.setMaxlength(40);
        ...
        if(!Language.getLoginLanguage().isLeftToRight()) {
    		...
    		lblUserId.setStyle("float: left;");
    		lblPassword.setStyle("float: left;");
    		lblLanguage.setStyle("float: left;");
    		txtUserId.setStyle("float: right;");
    		txtPassword.setStyle("float: right;");
    		lstLanguage.setStyle("float: right;");
    		chkSelectRole.setStyle("float: right;");  
    		chkRememberMe.setStyle("float: right;");
    		
    		//btnResetPassword.setStyle("float: left;");
    		//lblLogin.setStyle("float: left;");
    		//pnlButtons.setStyle("float: left;");
    		//pnlButtons.setStyle("float: left;");
		  ...
		  lblUserId.setStyle("float: right;");
  		  lblPassword.setStyle("float: right;");
  		 lblLanguage.setStyle("float: right;");
  		 txtUserId.setStyle("float: left;");
  		 txtPassword.setStyle("float: left;");
  		 lstLanguage.setStyle("float: left;");
  		chkSelectRole.setStyle("float: left;");
  		chkRememberMe.setStyle("float: left;");
...
//		String helpURL = MSysConfig.getValue(MSysConfig.LOGIN_HELP_URL, "https://www.tmkiin.net/");
...
//	}
    ...
    private void languageChanged(String langName)
    {
    	...
    	if(!Language.getLoginLanguage().isLeftToRight()) {
    		...
    		//pnlButtons.removeChild(helpButton);
    		pnlButtons.removeChild(okBtn);
    		//pnlButtons.addComponentsLeft(helpButton);
    		pnlButtons.addComponentsLeft(okBtn);
    		//btnResetPassword.setStyle("float: left;");
    		//lblLogin.setStyle("float: left;");
