...
//		ZKUpdateUtil.setWidth(bandbox, "100%");
		...
		if(!Language.getLoginLanguage().isLeftToRight()) {
            ...
            bandbox.setStyle("direction: rtl");
            tabPanel.setStyle("direction: rtl");
            tabPanels.setStyle("direction: rtl");
            tab.setStyle("direction:rtl");
            tabs.setStyle("direction:rtl");
            popup.setStyle("direction: rtl");
        }
        else {
            this.setStyle("direction: ltr");
          bandbox.setStyle("direction: ltr");
          tabPanel.setStyle("direction: ltr");
          tabPanels.setStyle("direction: ltr");
          tab.setStyle("direction:ltr");
          tabs.setStyle("direction:ltr");
          popup.setStyle("direction:ltr");
          }
